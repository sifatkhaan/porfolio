...
export default function Portfolio() {
  return (
      <div className="flex min-h-screen flex-col bg-gradient-to-t from-[#fbc2eb] to-[#a6c1ee]">
        <div>
          <div className="bg-[url('/image/srijon.jpg')] w-full h-[300px] bg-cover bg-center">
            <p className="font-berkshire text-5xl md:text-6xl text-white text-center p-3">
              {" "}
              Portfolio
            </p>
            <div className="grid grid-cols-2 gap-2 w-full h-[80px] my-3 justify-items-center font-berkshire"></div>
          </div>
          <section>
