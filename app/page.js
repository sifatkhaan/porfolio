      ...
      <div className="flex flex-col">
        ...
        <div className="bg-[url('/image/sunset.jpg')] w-full h-[300px] bg-cover bg-center">
          ...
          <div className="grid grid-cols-2 gap-2 w-full h-[80px] my-3 justify-items-center font-berkshire">
            <div className="bg-gradient-to-t from-[#fbc2eb] to-[#a6c1ee] p-1 text-center content-center w-3/4 md:w-1/4 rounded-lg shadow-lg">
              Are you a connoisseur? Do you like a connoissuer? Wow!! This is
              for you.. <p>Lets move on..</p>
            </div>
            <div className="bg-gradient-to-t from-[#fbc2eb] to-[#a6c1ee] p-1 text-center content-center w-3/4 md:w-1/4 rounded-lg shadow-lg">
              Hi!! This is Trisha Khalil. You can enjoy it or you can hire my
              excellency. Here you go...
            </div>
          </div>
        </div>
        <section>
